...
use crate::{config::AppConfig, database::JsonDatabase, services::openai::OpenAiClient};

use super::models::CreateAdMessageRequest;

pub async fn create_ad_message(
    db: web::Data<JsonDatabase>,
    req: web::Json<CreateAdMessageRequest>,
